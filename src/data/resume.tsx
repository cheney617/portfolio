...
export const DATA = {
  ...
  description:
    "做了8年半C端产品，一直在琢磨怎么让用户愿意掏钱、让业务能跑起来。",
  summary:
    "在携程做了5年，靠一个付费会员项目从应届生做到了带5个人的小团队，核心就是想明白了一件事：用户不会为「锦上添花」付费，但会为「解决焦虑」付费。后来去了TikTok，到悉尼做海外直播业务。一开始老老实实做工具，做着做着发现方向不对——平台拼命想把作者留在站内，作者拼命往外跑用自己的工具。这个矛盾不是多做几个功能就能解决的。后来花了大半年时间，拉着商业化、开放平台、外部合作方一起跑MVP验证，最终把「开放生态」这个方向推到了老板桌上。最近两年迷上了用AI干活，从写SQL到做PRD到Vibe Coding搭项目，真的回不去了。",
  avatarUrl: "/me.png",
  skills: [
