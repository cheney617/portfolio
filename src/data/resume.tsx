...
export const DATA = {
  ...
  description:
    "8.5年C端产品 · 擅长在模糊地带找到方向 · 用数据说服人 · 把跨团队的事推到落地",
  summary:
    "我的核心能力不是画原型和写PRD，而是**在没有人告诉我该做什么的时候，自己找到该做的事**。从用户数据和行业变化中识别机会，把发散的问题收敛成可验证的假设，拉通需要的资源跑MVP，用结果说服决策者下注。在携程做会员的时候，我学会了如何找到用户愿意付费的焦虑点。在TikTok做留资工具的时候，我学会了在做功能的过程中退后一步看方向——从「做什么工具」转变为「这个行业的作者到底需要什么商业模式」。海外工作2.5年，习惯在跨文化团队中推动共识。近两年用AI重构了自己的工作方式，也在探索AI如何变成产品能力本身。",
  avatarUrl: "/me.png",
  skills: [
