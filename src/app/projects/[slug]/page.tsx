...
const PROJECTS_DETAIL: Record<string, {
  ...
  "open-ecosystem": {
    ...
    backgroundTransition: "认清了这个矛盾后，我不再纠结于'自建还是集成'，而是重新定义方向：从闭环工具思维转向开放生态。我的方案是先用MVP验证两条线，再用数据驱动路径选择。",
  ...
  "subscription": {
    ...
    backgroundTransition: "基于竞品差距分析，我的方案分三步走：先开放单套餐自定义定价，再扩展到多档位套餐，最后叠加智能定价策略推荐。",
