...
const PROJECTS_DETAIL: Record<string, {
  ...
  "subscription": {
    title: "TikTok 订阅会员定价",
    subtitle: "多套餐+策略推荐定价体系",
    company: "TikTok LIVE",
    period: "2023.06 - 2024.10",
    tags: ["Pricing", "Strategy", "AB实验", "从0到1"],
    metrics: [
      { label: "被订阅数", value: "+8%" },
      { label: "被订阅率", value: "+2%" },
      { label: "收入", value: "+2%" },
    ],
    background: "TikTok直播订阅是平台对标Twitch/YouTube Membership的核心变现产品。但当时的问题是：只有单一套餐，作者不知道定什么价（定高了没人买，定低了不赚钱），用户觉得贵不愿意订。竞品已经支持多套餐分层定价，我们的基建明显落后。更深层的问题是：定价不能只靠作者拍脑袋，需要平台提供数据驱动的推荐。",
    backgroundTransition: "基于竞品分析和作者调研，我的方案是：先补齐多套餐基建，再叠加策略推荐定价能力。",
    flowDiagram: "竞品分析 → 多套餐架构 → 策略推荐定价 → AB实验验证",
    approach: [
      "多套餐架构设计：支持作者创建多个价格档位的订阅套餐，每个套餐可自定义权益组合。首套餐设置完成后预填推荐权益，引导快速完成多套餐配置",
      "简化开通流程：重新设计订阅开通设置流程，减少步骤和决策点，降低作者上手门槛",
      "低价入口+升级跃迁：支持低价订阅吸引用户先订阅，再通过权益差异引导升级至高价套餐，提升LTV",
      "策略推荐定价：结合作者历史订阅数据、所在地区用户消费能力、同类型作者的定价分布，算法推荐差异化定价方案。让定价从「作者猜」变成「平台推荐+作者确认」",
    ],
    approachTransition: "AB实验验证结果——",
    results: [
      "作者人均被订阅数+8%（AB实验结论）——多套餐让不同付费能力的用户都找到了入口",
      "人均被订阅率+2%（AB实验结论）——低价套餐有效降低了首次订阅的决策门槛",
      "收入+2%（AB实验结论）——升级跃迁机制开始贡献增量",
    ],
    resultsTransition: "回看这个项目——",
    reflection: "[TODO: 你的真实反思]",
    links: [],
  },
};
